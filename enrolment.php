...
<html>
	<head>
		...
		<title>Enrollment :: Don Bosco Secondary School Obosi</title>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-8 text-justify">
					<h3><span class="glyphicon glyphicon-book"></span> Enrollment Requirements</h3>
					<p>
						</p><hr>
						Don Bosco Secondary School offers admission for qualified candidates into:<br>
						JSS ONE and SSS ONE <br>
						ENTRY REQUIREMENTS: <br>
						FOR JSS ONE: Two recent passport size photographs a photocopy of 
candidate's 
						birth certificate / baptismal card a photocopy of last school 
result original copy of a medical rep 
						photocopy of last school result original copy of a medical report 
from any recognized mission hospital and one DBSS flat file.
						<hr>
						FOR S S 1 Two recent passport size photographs a photocopy of 
candidate's 
						birth certificate / baptismal card original (for vetting) and 
photocopy of BECE Result (Junior WAEC Result), 
						a photocopy of testimonial original copy of transfer certificate /
 letter original (for vetting) and photocopy of 
						a medical report from any mission hospital and one DBSS flat file.
 
						SUMISSION : Submission of photocopy of the Application Form is 
invalid. The Form MUST be submitted ONE WEEK before the examination 
date.
						<hr>
					<p></p>
					<p>
						<strong>DBSS ON ADMISSION PROCESS</strong>

						<br>- Entrance form is available from 31st January.
						<br>- The student must purchase an admission form, pass entrance 
examination and bring the necessary requirements before he could be 
given an admission letter with a payment list.
						<br>- The parent/guardian must meet up with the stipulated date on
 the admission letter least the termination of the ward(s) admission
					</p>
				</div>
				<div class="col-md-6 col-md-4 pull-right">
					<img src="img/imgslid14.jpg" class="img-responsive">
					<img src="img/imgslid7.jpg" class="img-responsive">
				</div>
			</div>
		</div>
				
		<div class="container panel panel-default">
			<h3 class="panel-heading"><span class="glyphicon glyphicon-usd"></span> Pricing</h3>
		...
		<div class="container text-right">
			<a href="registration.php" class="btn btn-primary"><span class="glyphicon glyphicon-hand-right"></span> Proceed to registration</a>
		</div>
